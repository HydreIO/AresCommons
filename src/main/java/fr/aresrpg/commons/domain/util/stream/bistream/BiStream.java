...
public interface BiStream<T, U> extends BaseStream<BiStream.BiValue<T, U>, BiStream<T, U>> {
	...
	/**
	 * Returns a stream consisting of the elements of this stream, sorted according to natural order. If the elements of this stream are not {@code Comparable}, a {@code java.i18n.ClassCastException} may be thrown when the terminal operation is executed.
	 *
	 * <p>
