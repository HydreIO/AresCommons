...
public interface Function<A , R> {
	...
	/**
     * Create a new function with another that will be executed before
     * @param before the function to apply before
    ...
    /**
     * Create a new function with another that will be executed after
     * @param after the function to apply after
