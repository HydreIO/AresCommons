	...
	public void writeValue(OutputStream out , TypeEnum type, Object value , SerializationContext context) throws IOException {
		switch (type){
			...
			case FLOAT:
				...
				break;
			case CHAR:
				out.write(STRING_DELIMITER);out.write((Character)value);out.write(STRING_DELIMITER);
				break;
			case NULL:
				out.write(JSON_NULL);
				break;
			case STRING:
				out.write(STRING_DELIMITER);out.write(((String)value).getBytes(ENCODING));out.write(STRING_DELIMITER);
				break;
			case COLLECTION:
